const reverseString = require('../app/app.js').reverseString;
...
describe("Produce the reverse order of a word: ", function() {
  ...
  describe("Case for palindromes", function() {
    ...
    it("should return true for `abiriba`", function() {
      expect(reverseString('anna')).toEqual(true);
    });

    it("should return true for `radar`", function() {
      expect(reverseString('radar')).toEqual(true);
    });

    it("should return true for `civic`", function() {
      expect(reverseString('level')).toEqual(true);
    });
